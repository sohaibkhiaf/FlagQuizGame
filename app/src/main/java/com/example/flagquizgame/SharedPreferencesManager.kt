...
class SharedPreferencesManager (context: Context) {
    ...
    fun initializeCountries() {
        ...
        // Kosovo
        editor.putString("name_79", "Kosovo")
        editor.putString("code_79", "XK")
        editor.putString("flag_79", "flag_kosovo")
        editor.putString("area_79", "10,887 km²")
        editor.putString("population_79", "1.6 million people")
